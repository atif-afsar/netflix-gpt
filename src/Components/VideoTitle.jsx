...
const VideoTitle = ({ title, overview }) => {
  return (
   <div className=" top-0 left-0 w-full h-screen flex items-center px-12 bg-gradient-to-r from-black/70 via-black/30 to-transparent z-10">
  <div className="p-6 rounded-lg max-w-2xl">
    <h1 className="text-5xl text-gray-200 font-bold mb-4 ">{title}</h1>
